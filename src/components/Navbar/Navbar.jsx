        ...
        <div className={`navbar flex-no-wrap ${isDark ? "bg-[#150d32]" : "bg-white"} top-0 z-10 fixed `}>
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className={`menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow  ${isDark ? "bg-[#150d32]" : "bg-base-100"} rounded-box w-52 space-y-2`}>
                        {
                            user ?
                                <>
                ...
                <h2 className="text-2xl font-bold">DREAM<span className="text-blue-500">DESTINATION</span></h2>
            </div>
